...
class CoreLib(object):
    ...
    def abrir_quitacao_eleitoral_para_evidencia_erro(self, nome: str, cpf: str, data_nascimento: str, nome_mae: str, nome_pai: str):
        try:
            ...
            # console('Validando mensagens de erro...')
            ...
            # elem_alert = self.page.query_selector("#ancora-1 > div > div.portalMessage.alert-message.warning")

            # msg_doc_invalido = 'Título de eleitor inválido'
            # elem_error = self.page.query_selector("#ancora-1 > div > div.portalMessage.alert-message.error")
        except:
            raise Exception('resultado fora do esperado')

    @keyword('quitacao eleitoral')
    def checar_quitacao_eleitoral(self, nome: str, cpf: str, data_nascimento: str, nome_mae: str = '', nome_pai: str = ''):
        try:
            msg_dados_invalidos = 'Os dados informados (nome, data de nascimento ou filiação) não conferem com aqueles constantes do Cadastro Eleitoral.'
            msg_doc_invalido = 'Título de eleitor inválido'
            ...
            textQuite = "abaixo qualificado(a) está QUITE"
